@testset "octree_merging, 1D particles" begin
    ...
    octree = OctreeMerge{1,2}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC)
    ...
    octree2 = OctreeMerge{1,2}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC)
    ...
    # symmetric octree with split at v0 = (0.0, 0.0, 0.0)
    octree = OctreeMerge{1,2}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC, bin_bounds_compute=OctreeBinBoundsInherit)
