@testset "merging_grid_merging, 0D particles" begin
    ...
    function create_particle_in_octant(octant, v_val; w=1.0)
        ...
        return Particle{0}(w, SVector{3,Float64}(v_x, v_y, v_z), SVector{0,Float64}())
    end
    ...
    mg = GridN2Merge{0}(4, 8, 2, 3.0, 2.0, 1.0)
