@testset "merging_grid_merging, 2D particles" begin
    ...
    function create_particle_in_octant(octant, v_val; w=1.0)
        ...
        return Particle{2}(w, SVector{3,Float64}(v_x, v_y, v_z), SVector{2,Float64}(1.0, -10.0))
    end
    ...
    mg = GridN2Merge{2}(4, 8, 2, 3.0, 2.0, 1.0)
