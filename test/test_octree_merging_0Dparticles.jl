@testset "octree_merging, 0D particles" begin
    ...
    octree = OctreeN2Merge{0}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC)
    ...
    octree2 = OctreeN2Merge{0}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC)
    ...
    # symmetric octree with split at v0 = (0.0, 0.0, 0.0)
    octree = OctreeN2Merge{0}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC, bin_bounds_compute=OctreeBinBoundsInherit)
