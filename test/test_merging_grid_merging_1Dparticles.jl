@testset "merging_grid_merging, 1D particles" begin
    ...
    function create_particle_in_octant(octant, v_val; w=1.0)
        ...
        return Particle{1}(w, SVector{3,Float64}(v_x, v_y, v_z), SVector{1,Float64}(1.0))
    end
    ...
    mg = GridN2Merge{1}(4, 8, 2, 3.0, 2.0, 1.0)
