@testset "octree_merging, 2D particles" begin
    ...
    octree2 = OctreeN2Merge{2}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC)
    ...
    # symmetric octree with split at v0 = (0.0, 0.0, 0.0)
    octree = OctreeN2Merge{2}(OctreeBinMidSplit; init_bin_bounds=OctreeInitBinC, bin_bounds_compute=OctreeBinBoundsInherit)
